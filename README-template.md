...
**Important:** Please use version ${next-release-tag} and above for direct writes, as previous
...
import zipfile
with zipfile.ZipFile(SparkFiles.get("spark-bigquery-support-${next-release-tag}.zip")) as zf:
  zf.extractall()
```
